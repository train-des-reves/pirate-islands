...
Le surveillant n'attend jamais activement un exécuteur ou un reviewer et ne fait pas de polling ad hoc de leurs tâches. Il traite les actions locales sûres, publie ses consignes, puis rend la main ; les statuts consignés, les messages formels `Entrée en revue`/`Go final`, les findings et les blocages sont lus au passage planifié de cinq minutes suivant.
